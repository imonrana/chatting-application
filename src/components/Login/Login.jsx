        ...
        <article className='w-1/2  ml-[180px]'>
            ...
            <form action="" className='pt-[32px] space-y-[60px]'>
                ...
                <fieldset className='w-fit relative'>
                    ...
                    <label className={`${onInputEmail ? " top-[-10px]  peer-focus:top-[-10px] text-[14px]  text-[rgb(3,1,76,0.50)]" : "top-1/2 -translate-y-1/2 text-sm "}
                      block font-sans font-semibold text-xl text-[#03014C] absolute peer-placeholder-shown:top-1/2 peer-placeholder-shown:-translate-y-1/2 peer-focus:top-0 peer-focus:text-sm peer-focus:text-[rgb(3,1,76,0.50)] transition-all duration-500  `} htmlFor="loginEmail">
                    Email Address
                    </label>
                </fieldset>
                ...
                <fieldset className='w-fit relative '>
                    ...
                    <label className={`${onInputPwd ? " top-[-10px]  peer-focus:top-[-10px] text-[14px]  text-[rgb(3,1,76,0.50)]" : "top-1/2 -translate-y-1/2 text-sm "}
